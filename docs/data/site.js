...
window.SITE = {
  ...
  issues: [
    {
      vol: 7,
      week: "2026.8.10–8.14週",
      published: "2026年8月17日（月）発行",
      title: "生活を売る会社 ― モバイルワールド（MWG）",
      hero: "weekly_assets/mwg_hero.png",
      url: "weekly07.html",
      summary: "路上でもち米を売った男の息子が興した携帯電話屋が、スマホから食品スーパーまでを握るベトナム最大級の小売に。2023年に純益−96%の壊滅→2025年に過去最高益の復活弧。二つのエンジン（家電×BHX）と、次の一手DMX 5億ドルIPO。相場面は反落の週（VIC急落で指数−2.2%）を分解。"
    },
    {
      vol: 6,
      week: "2026.8.3–8.7週",
  ...
  scorecard: [
    {
      vol:7, made:"2026/8/17",
      claim:"MWGの「復活」は株価に織り込まれたか——2023年に純益−96%の壊滅から2025年に過去最高益(7.03兆ドン)へ、H1'26も+約90%。だが2026予想PERは約12倍と過去平均18.8倍に2〜3割ディスカウント。内需回復(小売+12.9%)・BHXの黒字定着・FTSE流入が追い風、ICT飽和・EC価格圧力・生鮮の難度が逆風。対象週(8/10–8/14)はVin急落の下げ相場でMWG+1.97%と逆行高＝内需の防御力を確認",
      test:"BHXの黒字持続と単店成長・DMX上場後の評価・四半期業績の計画超過(通年計画9.2兆ドン)、内需(小売売上高)と外国人フローの方向を確認", verdict:null
    },
    {
